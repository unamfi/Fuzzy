...
public class estrellas extends JPanel
   ...
   //    /* 
        if (frameNumber < (NUM_FRAMES -(4-estrellas))) {
            //frameNumber = 0;          
           frameNumber++;
        }
// */
    ...
    protected void updatePicture(int frameNumber) {
        ...
        if (images[frameNumber] == null) {
            images[frameNumber] = createImageIcon("images/stars/T"
                                                  + frameNumber
                                                  + ".jpg");
        }
    ...
    public static void muestraEstrellas(int num_Estrellas) {
        numEstrellas=num_Estrellas;
        //declaracion de ventana
        JFrame frame = new JFrame("Puntuacion");
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        estrellas animator = new estrellas();
